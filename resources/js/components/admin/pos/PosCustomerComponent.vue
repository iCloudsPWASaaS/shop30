<template>
        ...
        <div id="customerModal" v-if="show" style="position:absolute;top:0;left:0;width:100%;height:100%;background:#fff;z-index:9999;display:flex;flex-direction:column;border-radius:12px;border:1px solid #D9DBE9;overflow:hidden;">
