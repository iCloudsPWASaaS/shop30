<template>
        ...
        <div id="orderPayment" v-if="show" style="position:absolute;top:0;left:0;width:100%;height:100%;background:#fff;z-index:9999;display:flex;flex-direction:column;border-radius:12px;border:1px solid #D9DBE9;overflow:hidden;">
            <div style="display:flex;align-items:center;justify-content:space-between;padding:16px 20px;border-bottom:1px solid #D9DBE9;background:#f8f9fa;flex-shrink:0;">
                ...
                <h3 class="capitalize font-medium"><!-- your title here --></h3>
