        ...
        <div class="relative overflow-hidden rounded-xl isolate">
            ...
            <router-link class="overflow-hidden rounded-xl w-full"
                ...
                <!-- <img :src="product.cover" alt="product"
                    class="w-full rounded-xl transition-all duration-300 group-hover:scale-105 group-hover:rotate-3"> --> <!-- extra -->
                <img :src="product.cover" alt="product"
                    class="w-full h-48 object-cover rounded-xl transition-all duration-300 group-hover:scale-105 group-hover:rotate-3">
            </router-link>
        </div>
